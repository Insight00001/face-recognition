...
class FaceRecognition:
    ...
    def encode_faces(self):
        for image in os.listdir("student_image"):
            face_image = fr.load_image_file(f"student_image/{image}")
        ...
        while True:
            ...
            if self.process_current_frame:
                ...
                for face_encoding in self.face_encodings:
                    match = fr.compare_faces(self.known_face_encodings,face_encoding)
                    name = "unknown"
                    confidence = "unknown"
            ...
            for(top,right,bottom,left),name in zip(self.face_locations,self.face_names):
                ...
                cv2.putText(frame,name,(left+6,bottom-6),cv2.FONT_HERSHEY_PLAIN,0.8,(255,255,255))
